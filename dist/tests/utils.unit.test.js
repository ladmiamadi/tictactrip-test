...
(0, globals_1.describe)("Justify text test", () => {
    (0, globals_1.it)("Should return a justified text correctly", () => {
        ...
        (0, globals_1.expect)(justify(text)).toBe("Longtemps, je me suis couché de bonne heure. Parfois, à peine ma bougie éteinte,\n" +
...
(0, globals_1.describe)('countWords function', () => {
    (0, globals_1.it)('should return the number of words in a paragraph', () => {
        const text = "should return the number of words in a paragraph";
        const result = countWords(text);
        (0, globals_1.expect)(result).toBe(9);
    });
});
